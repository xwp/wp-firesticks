...
function firesticks_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'firesticks' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'firesticks_custom_background_args', array(
...
add_action( 'after_setup_theme', 'firesticks_setup' );
 ...
 */
function firesticks_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'firesticks_content_width', 640 );
}
add_action( 'after_setup_theme', 'firesticks_content_width', 0 );
 ...
 */
function firesticks_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'firesticks' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'firesticks' ),
...
add_action( 'widgets_init', 'firesticks_widgets_init' );
...
function firesticks_scripts() {
	...
	wp_enqueue_script( 'firesticks-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
